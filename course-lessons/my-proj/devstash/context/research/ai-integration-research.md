...
Investigate best practices for integrating the Google GemAI "gemini-2.5-flash-lite" model into a Next.js application for the following features:
...
- Google GenAI SDK setup and configuration
...
- Context7 docs for Google GenAI SDK
